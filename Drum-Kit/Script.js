...
function sound(key) {
    switch (key) {
        ...
        case "a":
        var sound2 = new Audio("sounds/hihat-close.wav");
        sound2.play();
        break;
        ...
        case "d":
        var sound4 = new Audio('sounds/ride.wav');
        sound4.play();
        break;
        ...
        case "k":
        var sound6 = new Audio('sounds/tom-high.wav');
        sound6.play();
        break;
    
        case "l":
        var sound7 = new Audio('sounds/tom-low.wav');
        sound7.play();
        break;
